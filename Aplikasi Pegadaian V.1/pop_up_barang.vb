...
Public Class pop_up_barang

    Private Sub pop_up_barang_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        koneksi()
        barang()
        atur()
    End Sub
    ...
    Private Sub DataGridView1_CellClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataGridView1.CellClick
        Try
            ...
            Formadmin.labelkodebrang.Text = DataGridView1.Item(0, i).Value
            Formadmin.txtnamabarangtarnsaksi.Text = DataGridView1.Item(1, i).Value
        Catch ex As Exception
