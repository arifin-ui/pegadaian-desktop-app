...
Public Class pop_up_nasabah_petugas

    Private Sub pop_up_nasabah_petugas_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        koneksi()
        nasabah()
        atur()
    End Sub
